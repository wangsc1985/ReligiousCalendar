...
//        e("阳历：${currDateTime.toShortDateString()}")
        ...
        val dayCyl: Int
        var leapMonth = 0
        var baseDate= DateTime(1900,0,31)
        baseDate.timeZone=currDateTime.timeZone

        //求出和1900年1月31日相差的天数
        var offset = ((currDateTime.time.time - baseDate.time.time) / 86400000L).toInt()
        dayCyl = offset + 40
        monCyl = 14
...
//        e("--------------------- lunar 构造器结束 ----------------------")
    ...
    override fun toString(): String {
        return year.toString() + "年" + (if (leap) "闰" else "") + chineseNumber[month - 1] + "月" + getChinaDayString(day)
    }
    ...
    companion object {
        ...
        val lunarInfo = longArrayOf(0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2,
